...
export const Logo: React.FC<{ className?: string }>=({ className })=> (
  <div className={`flex items-center gap-3 select-none ${className || ''}`}> 
    <svg width="40" height="40" viewBox="0 0 64 64" aria-label="Ghost icon" role="img" className="text-foreground shrink-0">
    ...
    <span className="font-bold text-base sm:text-lg tracking-tight leading-none whitespace-nowrap">
      <span className="text-primary">Da-ghost42</span>
